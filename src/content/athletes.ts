...
export const ATHLETE_PROFILES: AthleteProfile[] = [
  ...
  { name: "Ashley", photo: "", tagline: "", bio: "Small but mighty. Unfortunately maybe too small, but don't tell her I said that." },
  ...
  { name: "Ahmed", photo: "", tagline: "", bio: "The only one who got paid to play sports. Also the only one to hurt themselves in a geriatric sport. In this group he may only need one hamstring." },
  ...
  { name: "Pam", photo: "", tagline: "P$", bio: "The heart of the delusion in this group, and the reason we're not balancing by gender. If you've seen her gymnastics videos from the early 2000s, you'd know balance wasn't her strong suit anyway." }
];
